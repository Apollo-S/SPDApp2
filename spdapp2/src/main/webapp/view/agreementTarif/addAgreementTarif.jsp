...
<body>
	<h1 align="center">Добавление нового тарифа к договору № <c:out value="${agreement.number}"/> </h1>
	<p>
			...
			<tr>
				<td valign="top">
					<div class="form-group">
						<input type="hidden" class="form-control" id="agreementId"
							name="agreementId" value=<c:out value="${agreement.id}"/>>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="configuring"
								name="configuring" placeholder="Введите сумму (конфигурирование)">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="programming"
								name="programming" placeholder="Введите сумму (программирование)">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="architecting"
								name="architecting" placeholder="Введите сумму (арх. доработки)">
						</div>
					</div>
					<div class="form-group">
