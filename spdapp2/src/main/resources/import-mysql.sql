...
VALUES
	(1, 'Тіточка', 'Олексій', 'Олександрович', 'Тіточка О.О.', '3164304017', NULL, 1, 1, 1),
	(2, 'Тиха', 'Світлана', 'Анатоліївна', 'Тиха С.А.', '2439903000', NULL, 7, 2, 0),
	(3, 'Ладановський', 'Юрій', 'Володимирович', 'Ладановський Ю.В.', '2836315256', NULL, 6, 3, 0);

TRUNCATE `account`;
INSERT INTO `account` (`id`, `spd_id`, `account_number`, `mfo`, `bank_name`, `optlock`)
VALUES
	(1, 1, '26006901362973', '300658', 'АТ "ОТП БАНК" (м. Київ)', 0),
	(2, 2, '26001901363041', '300658', 'АТ "ОТП БАНК", м. Київ', 0),
	(5, 3, '26004901362975', '300658', 'АТ "ОТП БАНК", м. Київ', 0);

TRUNCATE `address`;
INSERT INTO `address` (`id`, `country`, `region`, `city`, `street`, `building`, `flat`, `zip`, `optlock`)
VALUES
	(1, 'Україна', 'Київська обл.', 'м. Ірпень, смт. Гостомель', 'вул. Рекунова', '7', '59', '08290', 0),
	(6, 'Україна', NULL, 'м. Київ', 'пр-т Рокосовського', '10-А', '261', '04201', 0),
	(7, 'Україна', NULL, 'м. Київ', 'вул. Довженка', '14', '159', '03057', 0);
...
VALUES
	(1, 'ТОВ "ГЕОСАП"', '36483010', '', '', 0),
	(2, 'ООО "ТЕСТ"', '36846459', '', '', 0);

TRUNCATE `company_account`;
INSERT INTO `company_account` (`id`, `company_id`, `presentation`, `date_start`, `optlock`)
VALUES
	(1, 1, '26007007100038 в АТ "Піреус Банк МКБ", МФО 300658', '2013-01-01', 0),
...
VALUES
	(1, 1, 'Україна, 03150, м.Київ, вул. Горького, буд. 172, офіс 1020', '2012-01-01', 0),
	(2, 1, 'Україна, 03680, м.Київ, вул. Козацька, буд. 120/4, літ. Б', '2015-07-01', 0),
	(3, 2, '03432, Украина, г. Киев, ул. Крещатик, 38', '2016-08-13', 0);
...
VALUES
	(1, 1, 'Генеральний директор', 'Щедріна Ася Анатоліївна', 'Щедріна А.А.', '2013-01-01', '2014-02-28', 0),
	(2, 1, 'Генеральний директор', 'Стоян Олександр Володимирович', 'Стоян О.В.', '2014-03-01', NULL, 0),
	(3, 2, 'Генеральный директор', 'Слепаков Семен Валерьевич', 'Слепаков С.В.', '2017-05-01', NULL, 0);

TRUNCATE `esv_tax`;
INSERT INTO `esv_tax` (`id`, `value`, `date_start`, `optlock`)
VALUES
	(1, 398.0100000000, '2013-01-01', 0),
	(2, 422.6500000000, '2013-12-01', 0),
	(3, 478.1700000000, '2015-09-01', 0),
	(4, 303.1600000000, '2016-01-01', 0),
	(5, 319.0000000000, '2016-05-01', 0),
	(6, 341.0000000000, '2016-12-01', 0);

TRUNCATE `registration_info`;
INSERT INTO `registration_info` (`id`, `description`, `dated`, `optlock`)
VALUES
	(1, 'Запис в ЄДР № 2 357 000 0000 007784', '2013-01-03', 0),
	(2, 'Запис в ЄДР № 2 074 000 0000 021827', '2013-01-17', 0),
	(3, 'Запис в ЄДР № 2 069 000 0000 028918', '2013-01-09', 0);
